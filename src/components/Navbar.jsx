  ...
  return (
    <>
      <div className="absolute top-0 left-0 w-full z-10">
        ...
        {/*-------------------- Mobile Menu ---------------------------- */}
        <div className={`md:hidden ${showMobileMenu ? 'fixed w-full' : 'h-0 w-0'}  right-0 top-0 bottom-0 overflow-hidden bg-transparent transition-all backdrop-blur text-white`}>
